...
function map(x, callback){
  var newArray = [];
  each(x, function(item, index, array){ //callback has to be provided/could be anything, we defined this based on line 10
    
   newArray.push(callback(item));//each item modified by the given callback.  
